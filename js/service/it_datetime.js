function ItDateTime(date_time) {
	if (date_time == undefined) {
		...
		this.datetime = dateInstance.getFullYear() + getNumber(dateInstance.getMonth() + 1, 2) + getNumber(dateInstance.getDate(), 2) + getNumber(dateInstance.getHours(), 2) + getNumber(dateInstance.getMinutes(), 2) + getNumber(dateInstance.getSeconds(), 2);
	} else {
